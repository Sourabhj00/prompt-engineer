...
from scripts.run_eval import find_claude_cli, find_project_root, run_eval
...
def run_loop(
    ...
    resolved_claude_cli = claude_cli or find_claude_cli()
    ...
    for iteration in range(1, max_iterations + 1):
        ...
        all_results = run_eval(
            ...
            model=model,
            claude_cli=resolved_claude_cli,
        )
...
def main():
    ...
    parser.add_argument("--holdout", type=float, default=0.4, help="Fraction of eval set to hold out for testing")
    ...
    parser.add_argument("--claude-cli", default=None, help="Path to claude CLI executable (auto-detected if omitted)")
    ...
    claude_cli = args.claude_cli or find_claude_cli()
